...
namespace Watertight.FlowUI
{
    internal struct Rectangle : IEquatable<Rectangle>
    {
        ...
        public void ClipWith(Rectangle other)
        {
            MinPoint = Vector2.Max(MinPoint, other.MinPoint);
            MaxPoint = Vector2.Max(MaxPoint, other.MaxPoint);
        }

        public void ClipWithFull(Rectangle other)
        {
            MaxPoint = Vector2.Clamp(MaxPoint, other.MinPoint, other.MaxPoint);
            MinPoint = Vector2.Clamp(MinPoint, other.MinPoint, other.MaxPoint);
        }
